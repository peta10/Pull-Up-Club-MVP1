...
const VideoSubmissionForm: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto py-8 px-4">
      <div className="bg-gray-800 rounded-lg p-8">
        <h2 className="text-2xl font-bold text-white mb-6">Submit Your Video</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            disabled={!pullUpCount || !videoLink || !videoConfirmed || !videoAuthenticity || isSubmitting}
