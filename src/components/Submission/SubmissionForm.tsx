...
const SubmissionForm: React.FC = () => {
  ...
  const isSubscriber = new URLSearchParams(window.location.search).get('member') === 'true';
  const isResubmission = new URLSearchParams(window.location.search).get('resubmit') === 'true';
      ...
      <div className="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="bg-gray-800 rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-white mb-4">
            {isResubmission ? "Thank You for Your Resubmission!" : "Thank You for Your Submission!"}
          </h2>
      ...
      <div className="bg-gray-800 rounded-lg overflow-hidden">
        ...
        {!isSubscriber && (
          <div className="bg-gray-900 p-4">
            <div className="flex justify-between mb-2">
              {['Personal Info', 'Performance', 'Payment'].map((step, index) => (
                <span 
                  key={index} 
                  className={`text-sm ${
        ...
        <div className="p-6">
          <h2 className="text-2xl font-bold text-white mb-6">
            {isSubscriber ? (
              isResubmission ? 'Resubmit Your Video' : 'Submit Your Video'
            ) : (
              <>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                {isResubmission && (
                  <div className="bg-[#9b9b6f] bg-opacity-20 border-l-4 border-[#9b9b6f] p-4 mb-6">
                    <p className="text-white">
                      Your previous submission was rejected. Please ensure your new video follows all requirements before submitting.
                    </p>
                  </div>
                )}
                ...
                <div className="flex items-start mt-4">
                  ...
                  <label htmlFor="videoConfirmed" className="text-gray-300 text-sm">
                    I confirm that the video link I have provided is correct, publicly accessible, and viewable without requiring login credentials, permissions, or special access settings. I understand that if the link is broken, private, or otherwise inaccessible to Pull-Up Club administrators or judges, my submission may be disqualified. I acknowledge that Pull-Up Club will not reimburse any fees or provide refunds for submissions that cannot be reviewed due to inaccessible or improperly shared video links. <span className="text-[#9b9b6f]">*</span>
                  </label>
                </div>
                ...
                <div className="flex items-start mt-4">
                  ...
                  <label htmlFor="videoAuthenticity" className="text-gray-300 text-sm">
                    By submitting this video, I confirm that it is 100% authentic and represents a genuine, unaltered recording of my performance. I certify that the video has not been generated, enhanced, or manipulated using artificial intelligence (AI) tools or software of any kind. I also affirm that the footage has not been edited in a way that creates loops, repetitions, or visual effects intended to misrepresent the actual number of pull-ups performed. Any form of tampering, misrepresentation, or video manipulation will result in immediate disqualification and forfeiture of any associated entry fees, rankings, or rewards. <span className="text-[#9b9b6f]">*</span>
                  </label>
                </div>
              </div>
            )}
            ...
            {!isSubscriber && formState.step === 3 && (
              <div className="space-y-6">
                <div className="bg-gray-700 p-6 rounded-lg">
                  <h3 className="font-medium text-white mb-4 text-lg">Choose Your Subscription Plan</h3>
                  ...
                  <div className="space-y-4">
                    <div 
                      ...
                      onClick={() => dispatch({ type: 'UPDATE_FIELD', field: 'subscriptionType', value: 'monthly' })}
                    >
                      <div className="flex items-center">
                        <input
                          ...
                          onChange={() => dispatch({ type: 'UPDATE_FIELD', field: 'subscriptionType', value: 'monthly' })}
                    ...
                    <div 
                      ...
                      onClick={() => dispatch({ type: 'UPDATE_FIELD', field: 'subscriptionType', value: 'annual' })}
                    >
                      <div className="flex items-center">
                        <input
                          type="radio"
                          ...
                          onChange={() => dispatch({ type: 'UPDATE_FIELD', field: 'subscriptionType', value: 'annual' })}
                          className="w-5 h-5 mr-3 text-[#9b9b6f] focus:ring-[#9b9b6f] cursor-pointer"
                        />
                        <div className="flex-1">
                ...
                <div className="flex items-start mt-4">
                  <input
                    ...
                    required
                  />
                  <label htmlFor="consentChecked" className="text-gray-300 text-sm">
                    I agree to the <a href="#" className="text-[#9b9b6f] hover:underline">Terms of Service</a> and acknowledge 
                    that my submission may be used for promotional purposes. <span className="text-[#9b9b6f]">*</span>
                  </label>
                </div>
              </div>
            )}
            ...
            <div className="mt-8 flex justify-between">
              ...
              {!isSubscriber && formState.step < 3 ? (
                ...
                >
                  {isSubscriber ? (
                    isResubmission ? 'Resubmit Video' : 'Submit Video'
                  ) : (
                    `Subscribe ${formState.subscriptionType === 'monthly' ? '($9.99/month)' : '($99.99/year)'}`
                  )}
                </Button>
              )}
            </div>
